...
#define RELAY1_ON       PORTH|=0x20;                      // relay-1 on
#define RELAY1_OFF      PORTH&=~0x20;                      // relay-1 off
#define RELAY2_ON       PORTH|=0x40;                      // relay-1 on
#define RELAY2_OFF      PORTH&=~0x40;                      // relay-1 off
#define OPENDRAIN1_OFF  PORTH&=~0x08;
#define OPENDRAIN1_ON   PORTH|=0x08;
#define OPENDRAIN2_OFF  PORTH&=~0x10;
#define OPENDRAIN2_ON   PORTH|=0x10;
